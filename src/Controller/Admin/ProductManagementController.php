...
{
    #[Route(name: 'app_admin_product_management_index', methods: ['GET'])]
    public function index(ProductRepository $productRepository): Response
    {
        return $this->render('admin/product_management/index.html.twig', [
    ...
    #[Route('/{id}', name: 'app_admin_product_management_show', methods: ['GET'])]
    public function show(Product $product): Response
    {
        return $this->render('admin/product_management/show.html.twig', [
            'product' => $product,
        ]);
    }
